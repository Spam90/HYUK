...
export const RateLimiters = {
  ...
  upload: createRateLimiter({ limit: 30, windowMs: 60_000 }),      // subida de imágenes (autenticado)
  // Creación de pedidos (POST /api/orders):
  //  - por IP: un cliente real no hace 15 pedidos en un minuto; una red
  //    compartida (wifi de un centro comercial) sí puede tener varios.
  //  - por tienda: techo de seguridad contra abuso distribuido sin afectar
  //    el volumen normal de una tienda (60 pedidos/min = 1/segundo).
  orders: createRateLimiter({ limit: 15, windowMs: 60_000 }),
  orderStore: createRateLimiter({ limit: 60, windowMs: 60_000 }),
};
