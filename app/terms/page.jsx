...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-background text-text/90">
      <div className="max-w-3xl mx-auto px-4 py-16">
        <h1 className="text-3xl font-bold text-text mb-6">Términos de servicio</h1>
        <p className="text-sm text-text/60 mb-8">Última actualización: {new Date().toLocaleDateString('es-DO', { day: '2-digit', month: 'long', year: 'numeric' })}</p>

        <div className="space-y-6 text-sm leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">1. Aceptación</h2>
            <p>Al usar HYUK (&quot;el Servicio&quot;) aceptas estos términos. Si no estás de acuerdo, no utilices el Servicio.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-text mb-2">2. El Servicio</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">3. Cuentas</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">4. Pagos y planes</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">5. Limitación de responsabilidad</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">6. Contacto</h2>
