...
// =============================================
//
// IMPORTANTE: este motor controla el CATÁLOGO DEL NEGOCIO (colores, layout,
// tipografía de la tienda pública). Es independiente del tema Light/Dark de la
// aplicación administrativa, que se maneja con next-themes + la clase `.dark`.
//
...
// =============================================
// Opciones de Layout Type (Tipo de Layout de Tienda)
// =============================================
export const LAYOUT_TYPE_OPTIONS = [
  {
    value: 'grid_modern',
    label: 'Grid Modern (Boutique)',
    description: 'Tarjetas en cuadrícula de 2 columnas - Ideal para ropa y productos visuales',
  },
  {
    value: 'list_compact',
    label: 'List Compact (Licorería)',
    description: 'Lista horizontal de alta densidad - Ideal para minimarkets y licorerías',
  },
  {
    value: 'menu_card',
    label: 'Menu Card (Restaurante)',
    description: 'Tarjetas anchas con descripción e insignias - Ideal para restaurantes',
  },
];
