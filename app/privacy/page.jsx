  ...
  return (
    <div className="min-h-screen bg-background text-text/90">
      <div className="max-w-3xl mx-auto px-4 py-16">
        <h1 className="text-3xl font-bold text-text mb-6">Política de privacidad</h1>
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">1. Datos que recopilamos</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">2. Uso de los datos</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">3. Herramientas de IA</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">4. Almacenamiento y seguridad</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text mb-2">5. Tus derechos</h2>
